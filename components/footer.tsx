        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/meet-wendy" className="text-muted-foreground hover:text-foreground transition-colors">
                  Meet Wendy
                </Link>
              </li>
              <li>
                <Link href="/custom-trips" className="text-muted-foreground hover:text-foreground transition-colors">
                  Custom Trips
                </Link>
              </li>
              <li>
